...
def _dcf_editor(ticker):
    ...
    with _tab_fundamentals:
        ...
        st.markdown(
            ...
            f'background:{T["card"]};color:{T["text"]};border:1px solid {T["border_medium"]};'
            f'border-radius:8px;padding:10px 14px;font-size:0.78rem;line-height:1.5;'
            f'font-weight:400;width:300px;z-index:999;box-shadow:{T["shadow_hover"]};'
            f'pointer-events:none;transition:opacity 0.15s ease">'
            f'<b>FCF / Net Income</b> — hoeveel van de gerapporteerde winst écht binnenkomt als cash.<br><br>'
            f'Net income is accrual-boekhouding (boekt sales bij factureren, niet bij betalen). FCF is echt geld op de rekening. Het gat tussen beide wordt veroorzaakt door:<br>'
            f'• <b>Werkkapitaal</b>: groeiende voorraden + debiteuren slurpen cash<br>'
            f'• <b>Capex vs D&amp;A</b>: meer investeren dan afschrijven = lager FCF<br>'
            f'• <b>Non-cash items</b>: SBC, depreciation, herstructurering<br><br>'
            f'<b>Interpretatie:</b><br>'
            f'<b>&gt; 100%</b> non-cash charges of harvest-mode (capex &lt; D&amp;A)<br>'
            f'<b>80 − 100%</b> high quality, cash-rich earnings<br>'
            f'<b>50 − 80%</b> capex-zwaar of werkkapitaal-groei<br>'
            f'<b>&lt; 50%</b> red flag — of bewuste hyper-growth (groei verbruikt cash)<br><br>'
            f'<b>Per sectortype:</b> SaaS/payments 90-110%, industrials/utilities 50-80% normaal, retail-in-groei tijdelijk lager door inventory build.'
            f'</span></span></div>'
