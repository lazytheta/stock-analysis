...
def build_base_config(ticker, stock_price=0):
    ...
    # build_config only falls back to this same shares[-1]*price calc when its
    # own market_cap arg comes in as 0 — precomputed here since there is no
    # Yahoo market_cap to pass in the first place (see stock_price fallback above).
